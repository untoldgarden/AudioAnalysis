...
{
    [CustomEditor(typeof(AudioDataToVFX))]
    [CanEditMultipleObjects]
    public class AudioDataToVFXEditor : Editor
    {
        //SerializedProperty _analyzer;
        SerializedProperty _bindRMS;
        SerializedProperty _bindTexture;
        SerializedProperty _visualEffects;
        private void OnEnable()
        {
            //_analyzer = serializedObject.FindProperty("_analyzer");
            _visualEffects = serializedObject.FindProperty("_visualEffects");
        }
        ...
        {
            //base.OnInspectorGUI();
            AudioDataToVFX dataBinder = (AudioDataToVFX)target;

            serializedObject.Update();

            //EditorGUILayout.PropertyField(_analyzer);
            EditorGUILayout.PropertyField(_visualEffects);
